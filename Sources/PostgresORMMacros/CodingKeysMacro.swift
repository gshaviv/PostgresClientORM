...
extension TablePersistMacro: ExtensionMacro {
    public static func expansion(of node: AttributeSyntax,
                                 ...
                                 conformingTo protocols: [TypeSyntax], in _: some MacroExpansionContext) throws -> [ExtensionDeclSyntax]
    {
...
public struct CodingKeysMacro: MemberMacro {
                                 ...
                                 in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        return try expansion(of: node, providingMembersOf: declaration, keyType: keyType, customId: nil, idType: "", codableType: codingKeyType, in: context)
    }
                                 ...
                                 in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        var cases: [String] = try declaration.memberBlock.members.compactMap { member in
            ...
            if variableDecl.element(withIdentifier: "ColumnIgnored") != nil {
                ...
                let keyValue: String = switch keyType {
                case .snakeCase:
                    raw.snakeCased()
                default:
                    raw
        ...
        ] + (codableType == .none ? [] : makeCodable(for: node, with: declaration, customId: customId, idType: idType, isStruct: isStruct, keyType: codableType, staticMemberNames: staticMemberNames, in: context))
    }
