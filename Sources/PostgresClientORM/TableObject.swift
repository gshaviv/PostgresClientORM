...
public extension TableObject {
  ...
  func delete(transactionConnection: PGConnection? = nil) async throws {
  ...
  static func fetch(id: IDType?, transactionConnection: PGConnection? = nil) async throws -> Self? {
    guard let id else {
      return nil
    }
  ...
  nonmutating func insert(transactionConnection: PGConnection? = nil) async throws {
  ...
  nonmutating func update(transactionConnection: PGConnection? = nil) async throws {
    guard id != nil else {
  ...
  nonmutating func updateColumns(_ columns: ColumnName..., transactionConnection: PGConnection? = nil) async throws {
    guard id != nil else {
      throw TableObjectError.general("id is nil")
    }
...
public extension TrackingDirty where Self: TableObject {
  ...
  nonmutating func save(transactionConnection: PGConnection? = nil) async throws {
